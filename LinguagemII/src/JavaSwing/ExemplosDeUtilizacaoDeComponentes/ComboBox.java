...
public class ComboBox extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbPaises.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        cmbPaises.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Brasil", "Canadá", "Estados Unidos", "Portugal", "Irlanda" }));

        btnExibir.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnExibir.setText("Exibir Selecionado");
    ...
    private void btnExibirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExibirActionPerformed
        String mensagem = cmbPaises.getSelectedItem().toString();
