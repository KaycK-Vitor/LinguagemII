...
public class JavaSwing_05_JPasswordField extends javax.swing.JFrame {

    public JavaSwing_05_JPasswordField() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txpMensagem = new javax.swing.JPasswordField();
        ...
        txpMensagem.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtResultado, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
                    .addComponent(txpMensagem))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(35, 35, 35)
                .addComponent(txpMensagem, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(28, 28, 28)
    ...
    private void btnCliqueAquiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCliqueAquiActionPerformed
        ...
        String mensagem = String.valueOf(txpMensagem.getPassword());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JavaSwing_05_JPasswordField.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JavaSwing_05_JPasswordField().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPasswordField txpMensagem;
